...
import { createGmailInboundAdapterFactory, createGmailIngressAdapter } from '../../../../../src/mail-channel/gmail/inbound/adapter';
import { MailSyncError, parseIngressScope } from '../../../../../src/modules/mail-sync';
